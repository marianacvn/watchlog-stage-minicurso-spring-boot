...
import br.com.uast.watchlog.api.dto.UsuarioEntretenimentoRegisterDto;
...
@Entity
public class UsuarioEntretenimento {
	@Id
	...
	public UsuarioEntretenimento() {
	}

	public UsuarioEntretenimento(UsuarioEntretenimentoRegisterDto dto) {
		this.entretenimentoId = dto.entretenimentoId();
		this.usuarioId = dto.usuarioId();
		this.temporadaId = dto.temporadaId();
		this.episodioId = dto.episodioId();
		this.nota_avaliacao = dto.nota_avaliacao();
		this.comentario = dto.comentario();
		this.assistido = dto.assistido();
	}

	public UsuarioEntretenimento(UUID id, Entretenimento entretenimentoId, Usuario usuarioId, Temporada temporadaId,
